...
Rebecca Stockbridge built the ShowStats app as a Free app. This SERVICE is provided by Rebecca Stockbridge at no cost and is intended for use as is.

If you choose to use my Service, then you agree to the collection and use of information in relation to this policy. The Personal Information that I collect is used for providing and improving the Service. I will not use or share your information with anyone except as described in this Privacy Policy.

**Information Collection and Use**

This app uses Google Sign In to identify individual users. No Google user information (e.g., name, email, profile picture) is accessed or stored. This app also uses setlist.fm usernames to associate setlist.fm accounts with Google users. Custom user-entered data (e.g., show notes) is stored in Google Cloud Firestore.
